...
| `enable_container_for_text_to_sql` | Enables project or catalog for text to sql. | "Please enable project <project_name> for text to SQL" or "Enable text to SQL for my catalog id <catalog_id>" | >=0.2.0 | >=5.2.1 |
